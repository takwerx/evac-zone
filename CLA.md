# Evac Zone Contributor License Agreement

**Version 1.0**

## Why this exists — in plain English

Evac Zone is licensed under the AGPL so that it stays free: anyone who modifies
...
the copyright holder has standing to do so. If the copyright in Evac Zone is
...
2. **You grant TAKWERX a broad license to it** — broad enough to ship it in
   Evac Zone, to enforce the AGPL against someone who takes the project
...
does **not** allow TAKWERX to take Evac Zone closed — the AGPL grant already
...
which the copyright in Evac Zone is later assigned. Except for the
...
> it under the project's license, and I accept the terms of the Evac Zone
