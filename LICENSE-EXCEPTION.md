# Licensing notes for Evac Zone

Evac Zone is licensed under the **[GNU Affero General Public License v3.0 or
...
>
> As a special exception, the copyright holders of Evac Zone give you permission to
> combine, link with, and distribute Evac Zone, or a work based on Evac Zone, together
...
> resulting work that are Evac Zone, or a work based on Evac Zone.
>
...
**If you only install and use Evac Zone, none of this touches you.** Running the
...
- `app/src/main/java/com/atakmap/android/evaczone/plugin/PluginNativeLoader.java`
...
- `app/src/main/java/com/atakmap/android/evaczone/plugin/EvacZone.java`
- `app/src/main/java/com/atakmap/android/evaczone/plugin/EvacZonePreferenceFragment.java`
